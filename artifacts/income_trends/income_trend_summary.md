...
- `CRC` / `room_a`: max reservations in `2024-12` (16), max gross income in `2024-12` (1110000.00), max median ADR in `2025-04` (100000.00).
- `CRC` / `room_b`: max reservations in `2025-07` (14), max gross income in `2025-04` (1330000.00), max median ADR in `2025-04` (100000.00).
- `USD` / `room_a`: max reservations in `2025-12` (9), max gross income in `2025-12` (1931.00), max median ADR in `2025-12` (200.00).
- `USD` / `room_b`: max reservations in `2025-11` (12), max gross income in `2025-11` (2730.00), max median ADR in `2025-12` (220.00).
